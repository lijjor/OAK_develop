...
from PyQt5.QtCore import QObject, pyqtSignal, pyqtSlot, QRunnable, QThreadPool, QTranslator, QLocale
...
class DemoQtGui:
    ...
    def __init__(self):
        ...
        # QFontDatabase.addApplicationFont(str(Path(__file__).parent / "fonts" / "NotoSansSC-VF.ttf"))
        self.engine.addImportPath(str(Path(__file__).parent / "views"))
        translator = QTranslator()
        translator.load(QLocale(), "i18n", ".", str(Path(__file__).parent / "translations"), ".qm")
